...
TEST_CASE("non_neg_prefix_sum")
{
    SUBCASE("correctly returns true")
    {
        ...
        CHECK(non_neg_prefix_sum(begin(data), end(data)));
    }
    ...
    SUBCASE("correctly returns false")
    {
        ...
        CHECK_FALSE(non_neg_prefix_sum(begin(data), end(data)));
    }
...
TEST_CASE("non_pos_prefix_sum")
{
    SUBCASE("correctly returns true")
    {
        ...
        CHECK(non_pos_prefix_sum(begin(data), end(data)));
    }
    ...
    SUBCASE("correctly returns false")
    {
        ...
        CHECK_FALSE(non_pos_prefix_sum(begin(data), end(data)));
    }
